                ...
                @foreach ($keluhan as $item)
                  <tr>
                    ...
                    <td class="align-middle">
                        <a href="{{  url('admin/keluhan/edit/'.$item->id) }}" class="btn btn-primary btn-sm">
                            <i class="fa fa-pencil"></i>
                        </a>
                        <form action="{{ url('admin/keluhan/'.$item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus Data?')">
                        @method('delete')
                        @csrf
